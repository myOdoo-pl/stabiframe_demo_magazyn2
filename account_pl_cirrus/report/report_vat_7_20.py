...
from odoo.addons.account_pl_cirrus.data.structures import JPK_VAT_7_20
...
class ReportVat7_20(models.AbstractModel):
    _name = 'report.account_pl_cirrus.report_vat_7_20'
    ...
    def render_xml(self, data):
        ...
        doc = Document()
        xml_element = VatUtils.convert_to_xml(JPK_VAT_7_20, wizard, doc, vat_dict)
        ...
        try:
            xml_utilities.check_xml_file(ready_xml, 'account_pl_cirrus/schemes/VAT-7(20)_v1-0E.xsd')
