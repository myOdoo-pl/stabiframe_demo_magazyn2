...
class AccountMove(models.Model):
    ...
    correction_untaxed = fields.Monetary(string='Untaxed Amount',
        store=True, readonly=True, compute='_compute_amount_correction', track_visibility='always')
        ...
        for tax_line in refund_tax_lines:
            ...
            if original_line:
                ...
                lines.append({
                    ...
                    'amount_base': original_line['amount_base'] - tax_line['amount_base'],
                    'gross_amount': original_line['gross_amount'] - tax_line['gross_amount'],
                    'foreign_cur': tax_line['foreign_cur'],
                    'country_tax': original_line['country_tax'] - tax_line['country_tax']
                })
        return lines
