...
from odoo.addons.account_pl_cirrus.data.structures import JPK_VAT_7_18
...
class ReportVat7_18(models.AbstractModel):
    _name = 'report.account_pl_cirrus.report_vat_7_18'
    ...
    def render_xml(self, data):
        ...
        doc = Document()
        xml_element = VatUtils.convert_to_xml(JPK_VAT_7_18, wizard, doc, vat_dict)
        ...
        try:
            xml_utilities.check_xml_file(ready_xml, 'account_pl_cirrus/schemes/VAT-7(18)_v1-1E.xsd')
