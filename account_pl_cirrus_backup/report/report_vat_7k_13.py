...
from odoo.addons.account_pl_cirrus.data.structures import JPK_VAT_7K_13
...
class ReportVat7k_13(models.AbstractModel):
    _name = 'report.account_pl_cirrus.report_vat_7k_13'
    ...
    def render_xml(self, data):
        ...
        xml_element = VatUtils.convert_to_xml(JPK_VAT_7K_13, wizard, doc, vat_dict)
        ...
        try:
            xml_utilities.check_xml_file(ready_xml, 'account_pl_cirrus/schemes/VAT-7K(13)_v1-0.xsd')
